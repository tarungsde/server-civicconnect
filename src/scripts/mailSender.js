...
sgMail.setApiKey("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");

// Use your verified Gmail address
const FROM_EMAIL = 'Civic Connect <yadavatarun18@gmail.com>';
...
export const sendStatusUpdateEmail = async (email, name, report, adminNotes = '') => {
  ...
  try {
    ...
    console.error('Error sending status update email:', error.response?.body || error);
    throw error;
  }
};
...
export const sendWelcomeEmail = async (email, name) => {
  const msg = {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="footer">
              <p>Need help? <a href="mailto:yadavatarun18@gmail.com" style="color: #007bff;">Contact our support team</a></p>
    ...
    text: `
      ...
      Need help? Contact our support team: yadavatarun18@gmail.com
